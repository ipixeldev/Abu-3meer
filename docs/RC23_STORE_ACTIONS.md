...
> release; use `APP_REVIEW_PHYSICAL_DEVICE_VIDEO.md` and build 34 instead.
...
1. Install/open TestFlight build 34, then use **Members → View plans →
...
declaration are filled. Remaining owner actions are to provide the build-34
